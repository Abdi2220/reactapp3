...
const NewWeather = () => {
  ...
  return (
    <section className="pt-20 pb-8 px-8  min-h-screen">
      ...
      {isLoading && <Loader />}
      {error && <p className="text-red-500">Der opstod en fejl. Prøv igen.</p>}
      ...
      <div className="flex justify-center mt-10">
        <div className="mr-10">
          ...
          <datalist id="zipcodes"> {postnumre.map(p => (
            <option key={p.postnr} value={p.postnr}>{p.postnr} {p.by}
            </option>
          ))}
