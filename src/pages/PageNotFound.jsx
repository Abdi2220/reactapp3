...
const PageNotFound = () => {
    return (
        ...
        <section className="grid min-h-full ml-48 place-items-center  px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#" className="rounded-md  px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs  focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Go back home</a>
